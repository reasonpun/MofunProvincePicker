...
import com.mofunsky.library.adapters.ArrayWheelAdapter;
import com.mofunsky.library.widget.OnWheelChangedListener;
import com.mofunsky.library.widget.WheelView;
...
public class CitiesActivity extends Activity implements OnWheelChangedListener {
    ...
    public void showChoose(View view) {
        Toast.makeText(this, mCurrentProviceName + mCurrentCityName + mCurrentAreaName, Toast.LENGTH_SHORT)
                .show();
    }
}
